package com.qw73.shaders.shaders

import org.intellij.lang.annotations.Language

@Language("GLSL")
val purpleLiquidShaderCode = """
/*
...
vec3 getRGB(in Field fld, in int mode) {
    ...
    // Обработка неизвестных режимов или возврат значения по умолчанию
    return vec3(0.0); // Например, возвращаем черный цвет
}
